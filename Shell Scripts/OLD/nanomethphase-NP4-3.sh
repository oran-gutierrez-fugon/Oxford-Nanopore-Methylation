...
#converts fast5 to more efficient slow5 and puts all slow5 flushes in same directory. Installed slow5 tools in conda base env (save more space using --to blow5 binary format)*warning* folders must be varified not just replace replicate name
conda activate
...
slow5tools merge -t 20 --to blow5 /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/slow5/NP4-3  -o /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/slow5/NP4-3/NP4-3cat.blow5
...
conda activate f5c
f5c index -t 10 --slow5 /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/slow5/NP4-3/NP4-3cat.blow5 /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/catcat/NP4-3.fastq.gz
