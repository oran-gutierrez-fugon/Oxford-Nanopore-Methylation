...
#converts fast5 to more efficient slow5 and puts all slow5 flushes in same directory. Installed slow5 tools in conda base env (save more space using --to blow5 binary format)*****warning***** input fast5,PF,PF2 folders must be verified one by one not just replace replicate name - this is main reason for skipped read errors in downstream methylation calling with f5c
conda activate
...
slow5tools merge -t 20 --to blow5 /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/slow5/UDP4-2  -o /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/slow5/UDP4-2/UDP4-2cat.blow5
...
conda activate f5c
f5c index -t 60 --slow5 /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/slow5/UDP4-2/UDP4-2cat.blow5 /share/lasallelab/Oran/dovetail/luhmes/nanoRAW/catcat/UDP4-2.fastq.gz
