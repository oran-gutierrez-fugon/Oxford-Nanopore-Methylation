...
#Generally have not seen any part of this taking up more than 12 GB of memory with 60 cores going but to be safe and respect epigenerate use can use the this command to limit ram usuage before killing the job at 75GB
ulimit -v 75000000
