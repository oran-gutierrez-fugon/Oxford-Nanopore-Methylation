...
rm /share/lasallelab/Oran/dovetail/luhmes/methylation/phasing/NeuronsPat/DMA/*.*
...
#for comparing one replicate from the paternal allele in differentiated  vs undifferentiated cells, only using one replicate from each group NP4-3
conda activate /share/lasallelab/Oran/test_nanomethphase/NanoMethPhase/nanometh-environment
cd /share/lasallelab/Oran/test_nanomethphase/NanoMethPhase
